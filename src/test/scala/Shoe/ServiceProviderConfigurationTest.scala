...
import Shoe.reader.mycomponent.MyStreamReaderImpl
import Shoe.transformer.mycomponent.MyStreamTransformerImpl
import Shoe.writer.mycomponent.MyStreamWriterImpl
